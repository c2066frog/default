...
$(function () {
    ...
    pcEgg.bressBG(), $("#hourtxt").show(), $("#opening").hide(), bgMusic(), pcEgg.Data(t, n), pcEgg.floatFun()
}, pcEgg.stopVid = function (t, n) {
    $("#hourtxt").show(), $("#opening").hide(), pcEgg.Data(t, n), stopAnimate(t.numArr), isTry = !1
}, pcEgg.Data = function (t, n) {
    $("#nextIssue").text(t.nextIssue), $("#drawTime").text(t.drawTime.split(" ")[1]), headCode(t.numArr), kaiCode(t.numArr), pcEgg.cutTime(t.timeremain, n)
    ...
    console.log(t), timer = setInterval(function () {
        ...
        } else clearInterval(timer), $("#hourtxt").hide(), $("#opening").css("display", "block"), clearInterval(animateId.floatInt), pcEgg.startRoate(), setTimeout(pubmethod.doAjax(n.issue, n.lotCode, n.type, !1), "500")
    }, 1e3)
