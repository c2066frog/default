...
$(function () {
    ...
    $("#hourtxt").show(), $("#opening").hide(), clearInterval(KJinit), bgMusic(), KJing < 5 ? setTimeout(function () {
        syxwV.stopAllFun(i.preDrawCode), KJing = 0
    }, 5e3) : (syxwV.stopAllFun(i.preDrawCode), KJing = 0), syxwV.Data(i, 2, n)
}, syxwV.Data = function (i, n, t) {
    $(".numList").find("ul").empty();
    var a = i.preDrawCode;
    1 == n && (a = syxwV.moveEle(a)), $("#issue").text(i.preDrawIssue), $("#kaiTime").text(i.drawTime.split(" ")[1]), syxwV.cutTime(i.cutime, t);
    ...
    timer = setInterval(function () {
        if (i >= 1) {
            ...
            KJing++
        }, 1e3), syxwV.startFun(), setTimeout(pubmethod.doAjax(n.issue, n.lotCode, n.type, !1), "500")
    }, 1e3)
