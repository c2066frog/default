...
function animate() {
    ...
    var L = document.getElementById("car1"), _ = document.getElementById("car2"), H = document.getElementById("car3"),
        N = document.getElementById("car4"), C = document.getElementById("car5"), S = document.getElementById("car6"),
        q = document.getElementById("car7"), G = document.getElementById("car8"), Y = document.getElementById("car9"),
        D = document.getElementById("car10");
    TweenMax.to(L, a, {left: $, delay: d}), TweenMax.to(_, t, {left: M, delay: m}), TweenMax.to(H, e, {
        left: x,
        delay: u
    }), TweenMax.to(N, n, {left: I, delay: p}), TweenMax.to(C, o, {left: T, delay: f}), TweenMax.to(S, r, {
        left: B,
        delay: y
    }), TweenMax.to(q, l, {left: k, delay: h}), TweenMax.to(G, i, {left: E, delay: v}), TweenMax.to(Y, s, {
        left: b,
        delay: g
    }), TweenMax.to(D, c, {left: A, delay: w})
}
...
function checkposition() {
    ...
    for (n = 0; n < 10; n++) {
        var a = n + 1, t = parseInt($("#car" + a).css("left"));
        t = (t += carpositionoffset[n]) + "." + n, carposition[n] = parseFloat(t)
    }
    carposition.sort(sortFloat);
    for (n = 0; n < 10; n++) {
        var e = carposition[n];
        e = String(e), my_array = e.split("."), void 0 == my_array[1] ? carsequence[n] = "0" : carsequence[n] = my_array[1]
    }
    for (var n = 0; n < 10; n++) {
        var o = "#pos" + (n + 1), r = -80 * carsequence[n];
        $(o).css("background-position", "0px " + r + "px")
    }
}

function wheelon() {
    for (var a = 1; a < 11; a++) $(".wheel" + a + "a").css("display", "block"), $(".wheel" + a + "b").css("display", "block")
}
...
function startcountdown(a, t) {
    ...
    stopanimation(), $("#car1").css("left", "1206px"), $("#car2").css("left", "1197px"), $("#car3").css("left", "1181px"), $("#car4").css("left", "1166px"), $("#car5").css("left", "1153px"), $("#car6").css("left", "1139px"), $("#car7").css("left", "1128px"), $("#car8").css("left", "1105px"), $("#car9").css("left", "1084px"), $("#car10").css("left", "1067px"), $(".roadstart").css("left", "960px"), $(".trafficlight").css("display", "block"), $(".redlight").css("display", "none"), $(".yellowlight").css("display", "none"), $(".greenlight").css("display", "none"), $(".countdownnum").html(""), $(".countdownnum2").html(""), $(".countdownnum").css("display", "block"), $(".countdownnum2").css("display", "block"), countdowninv = setInterval(function () {
        countdowntimer(a -= 1), countdown(a), 0 == a && (clearInterval(countdowninv), clearInterval(countdowninv2), setTimeout(pubmethod.doAjax(t.issue, t.lotCode, t.type, !1), "2000"))
    }, 1e3);
    var e = 99;
    countdowninv2 = setInterval(function () {
        minisectimer(e), 0 == e && (e = 99), e -= 1
...
function countdown(a) {
    var t = a / 60;
    if (0 == (t = Math.floor(t))) var e = "00"; else e = convertTime(e = String(t));
    var n = convertTime(a - 60 * t);
    a < 0 ? $(".countdownnum").html("00:00") : $(".countdownnum").html(e + ":" + n)
}

function countdowntimer(a) {
    a >= 0 ? $(".trafficlight").css("display", "block") : $(".trafficlight").css("display", "none"), a <= 2 && a > 0 && ($(".redlight").css("display", "block"), playing.pause(), playing = document.getElementById("cuttime"), isplay && playing.play()), a <= 1 && $(".yellowlight").css("display", "block"), 0 == a && (startanimation(), $(".countdownnum").html("00:00"), $(".countdownnum2").html("00"), $(".greenlight").css("display", "block"), $(".trafficlight").delay(500).fadeOut(300))
}

function startanimation() {
    $(".wheel10a img").css("animation", "twinkling 0.01s  ease-in-out  infinite"), playing.pause(), playing = document.getElementById("running"), isplay && playing.play(), addint = setInterval(function () {
        ShipUndulation()
    }, 200), wheelon();
    var a = document.getElementById("roadstart");
    TweenMax.to(a, 1, {left: "1334px", ease: Power1.easeIn});
    var t = document.getElementById("roaditm");
    TweenMax.to(t, .4, {left: "-120px", repeat: -1, ease: Linear.easeNone});
    var e = document.getElementById("scenaryitm");
    TweenMax.to(e, 20, {
        left: "0",
        repeat: -1,
        ease: Linear.easeNone
    }), $("wheel1a").css("display", "block"), $("wheel1b").css("display", "block"), animation1 = setInterval(function () {
        animate()
...
function stopanimation() {
    $("#roaditm").css("left", "-1300px"), $("#scenaryitm").css("left", "-1334px"), $(".flame").css("display", "none"), TweenMax.killAll(), wheeloff_2(), $(".wheel10a img").css("animation", "initial"), clearInterval(animation1), clearInterval(animation2), clearInterval(animation3), clearInterval(countdowninv), clearInterval(countdowninv2), clearInterval(addint), running.pause(), playing = empt
}
...
function finishgame(a, t) {
    ...
    TweenMax.to(e, .4, {left: "-120px", repeat: -1, ease: Linear.easeNone});
    ...
    TweenMax.to(o, 1, {left: "1334px", ease: Linear.easeNone, delay: 3});
    ...
    for (var l = a.split(","), i = 0; i < 10; i++) {
        ...
        s /= 10;
        var c = parseInt(l[i]) - 1, d = 100 * i - carpositionoffset[c] + 350, m = d + "px", u = "car" + l[i],
            p = document.getElementById(u);
        activateflame(d, l[i]), TweenMax.to(p, 3, {left: m, delay: s})
    }
...
function resultpage(a) {
    ...
    for (var t = a.split(","), e = 0; e < 10; e++) {
        var n = parseInt(t[e]) - 1, o = 100 * e - carpositionoffset[n] + 350 + "px", r = "car" + t[e];
        $("#" + r).css("left", o)
    }
...
var animation1, animation2, waitfinish, addint, carHeight = [], isplay = !0, ifopen = !0, playing = "";
$(function () {
...
var countdowninv, countdowninv2, animation3 = setInterval(function () {
    windflameani()
}, 150), soundBtn = document.getElementById("soundBtn");
soundBtn.onclick = function () {
    "on" == this.className ? (this.className = "off", isplay = !1, playing.pause()) : (this.className = "on", isplay = !0, playing.play())
};
var fun = {};
fun.stateSound = function () {
    running.play(), kaisound.play(), running.pause(), kaisound.pause()
}, fun.fillHtml = function (a, t) {
    $("#currentdrawid").html(a.currNum), $("#nextdrawid").html(a.currid), $("#stat1_1").html(a.GuaYaArr[0]), $("#stat1_2").html(a.GuaYaArr[1]), $("#stat1_3").html(a.GuaYaArr[2]), $("#stat2_1").html(a.LoHuArr[0]), $("#stat2_2").html(a.LoHuArr[1]), $("#stat2_3").html(a.LoHuArr[2]), $("#stat2_4").html(a.LoHuArr[3]), $("#stat2_5").html(a.LoHuArr[4]), showcurrentresult(a.result), void 0 != t && startcountdown(t)
};
var obj = {
    currNum: 36,
    currid: 12345678,
