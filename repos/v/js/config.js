function popup() {
    $(".pupbody").append("<div id='popup'><div class='pupbox'><button id='pupbtn'></button><img src='img/imginfo-pc.png'/></div></div>"), $("html,body").css({overflow: "hidden"})
}

function pupout() {
    if (!($("#popup").length < 1)) {
        var i = localStorage.getItem("pupday");
        null == i && (i = "0"), 1 * i != 1 * (new Date).getDate() && popup()
    }
}
...
function jumpBox() {
    ...
    }), $(".logo,.nameLogo").on("click", function () {
...
function getH(i) {
    switch (1 * i) {
        ...
        case 10054:
            ...
            break;
        case 10055:
            jumpHtml("view/shiyix5_jisu/kjhistory.html"), view, tencent_ffc, ssc_kjhistory.html;
            break;
        case 10056:
...
function operatorTime(i, e) {
    var t = i.replace("-", "/"), e = e.replace("-", "/");
    return t = t.replace("-", "/"), e = e.replace("-", "/"), (new Date(t).getTime() - new Date(e).getTime()) / 1e3
}

var config = {
    publicUrl: "//999j-k.jio.123tutao.com/api/",
    wwwUrl: "//1682013.co",
    ifdebug: !1,
    listTime: 2e3,
    startTime: 1e3,
    ...
    path: function () {
        var i = window.location.href, e = "https" == i.split(":")[0] ? "https" : "http";
        return config.ifdebug ? e + "://" + i.split("/")[2] + "/kaiTransfer/view/" : -1 != i.split("/")[2].indexOf("192") ? e + "://" + i.split("/")[2] + "/kaiTransfer/view/" : e + "://" + i.split("/")[2] + "/view/"
    },
    ym: function () {
    ...
    jump: function () {
        var i = window.location.search.split("?");
        return i = i[i.length - 1], "" != window.location.port ? "//" + config.wwwUrl + "/" : "" == i || void 0 == i ? "//" + config.wwwUrl + "/" : -1 != i.indexOf("168") ? "//" + i + "/" : "//" + config.wwwUrl + "/"
    }
}, oldLog = console.log;
...
$(function () {
    pupout(), $("body").on("click", "#popup", function (i) {
        i.stopPropagation();
        var e = $(i.target);
